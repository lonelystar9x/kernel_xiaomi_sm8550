...
static char off_boot[2] = {0};
module_param_string(off_mode_charging, off_boot, 2,0644);
...
static void mtdoops_notify_add(struct mtd_info *mtd)
{
	...
	atomic_notifier_chain_register(&pwrkey_irq_notifier_list, &cxt->pwrkey_long_press_nb);
